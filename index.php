...
<section class="hero-banner">
    <div class="banner-content-area">
        ...
        <h1 class="banner-hd">Go on your last first date.</h1>
        <p class="banner-para"> Vestibulum suscipit congue ligula, et efficitur mi iaculis ut. Aliquam in arcu.</p>
...
<section class="connect-sec">
    <div class="container">
        <div class="row row-gap-5">
            ...
            <div class="col-lg-6 col-md-12">
                <img src="assets/images/connect-img.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
<section class="chemistry-sec">
    <div class="match-box">
        <div>
            <h5>Perfect Match</h5>
            <img src="assets/images/match-img1.png" alt="">
        </div>
        <div>
            <h5>Love Journey</h5>
            <img src="assets/images/match-img2.png" alt="">
        </div>
        <div>
            <h5>Couple Goals</h5>
            <img src="assets/images/match-img3.png" alt="">
        </div>
    </div>
    <div class="meet-box">
...
<!-- <section class="explore-sec">
    <div class="explore-wrapper">
        <div class="explore-left">
            ...
            <p class="sec-para">It is a long established fact that a reader will its layout.</p>
            <a href="#" class="secondary-btn">Register Now</a>
        </div>
        <div class="explore-right">
            <img src="assets/images/location-img1.png" alt="" class="locat-img">
            <div class="location-box">
                <h5>United Kingdom</h5>
                <p>1657 Singles <img src="assets/images/dot-img.png" alt=""></p>
            </div>
        </div>
    </div>
    <div class="other-location-wrapper">
        <div>
            <img src="assets/images/location-img2.png" alt="" class="locat-img">
            <div class="location-box">
                <h5>Taipei</h5>
                <p>1657 Singles <img src="assets/images/dot-img.png" alt=""></p>
            </div>
        ...
        <div>
            <img src="assets/images/location-img3.png" alt="" class="locat-img">
            <div class="location-box">
                <h5>Abu Dhabi</h5>
                <p>1657 Singles <img src="assets/images/dot-img.png" alt=""></p>
            </div>
        ...
        <div>
            <img src="assets/images/location-img4.png" alt="" class="locat-img">
            <div class="location-box">
                <h5>Barcelona</h5>
                <p>1657 Singles <img src="assets/images/dot-img.png" alt=""></p>
            </div>
        ...
        <div>
            <img src="assets/images/location-img5.png" alt="" class="locat-img">
            <div class="location-box">
                <h5>San Francisco</h5>
                <p>1657 Singles <img src="assets/images/dot-img.png" alt=""></p>
            </div>
...
<section class="about-sec">
    ...
    <div class="about-slider-wrapper">
        ...
        <div class="about-btn-wrapper">
            <button class="about-button-prev slider-btn"><i class="fa-solid fa-arrow-left"></i></button>
